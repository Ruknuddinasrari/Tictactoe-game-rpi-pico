...
int main() {
  ...
  GpioConfig my_gpio[NUMBER_OF_GPIOS] = {[0]={.pin_number=LED1, .pin_dir=GPIO_OUT},
                                         [1]={.pin_number=LED2, .pin_dir=GPIO_OUT},
                                         [2]={.pin_number=BTN1, .pin_dir=GPIO_IN},
                                         [3]={.pin_number=BTN2, .pin_dir=GPIO_IN},
                                         [4]={.pin_number=BTN3, .pin_dir=GPIO_IN},
                                         [5]={.pin_number=ONBOARD_LED, .pin_dir=GPIO_OUT},
                                         };
